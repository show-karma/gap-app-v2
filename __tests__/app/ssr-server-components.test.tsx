...
describe("SSR Server Components", () => {
  ...
  describe("CommunityProjectsPage", () => {
    ...
    const importPage = async () => {
      const mod = await import(
        "@/app/t/[tenant]/community/[communityId]/(with-header)/projects/page"
      );
      return mod.default;
    };
  ...
  describe("RoadmapPage (Project Updates)", () => {
    const importPage = async () => {
      const mod = await import("@/app/t/[tenant]/project/[projectId]/updates/page");
      return mod.default;
    };
  ...
  describe("CommunityMainPage (with-header)", () => {
    const importPage = async () => {
      const mod = await import("@/app/t/[tenant]/community/[communityId]/(with-header)/page");
      return mod.default;
    };
