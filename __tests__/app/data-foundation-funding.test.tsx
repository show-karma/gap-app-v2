...
import {
  ...
  DATA_PAGE_TITLE,
  DATASET_DESCRIPTION,
} from "@/app/t/[tenant]/(chrome)/data/foundation-funding/content";
import FoundationFundingDataPage, { metadata } from "@/app/t/[tenant]/(chrome)/data/foundation-funding/page";
...
describe("/data/foundation-funding content", () => {
  ...
  it("hardcodes no corpus figure as a literal in the page or content source", () => {
    ...
    const routeDir = path.resolve(__dirname, "../../app/t/[tenant]/(chrome)/data/foundation-funding");
