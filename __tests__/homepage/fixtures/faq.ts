...
export const mockFAQItems: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      "Your profile is your public, onchain portfolio. Include: A clear description of your project and goals, Milestones or deliverables you plan to achieve, Updates on your progress (with links, screenshots, or metrics), Any impact results or endorsements you receive. The more complete your profile, the easier it is for funders and collaborators to discover and trust your work.",
  },
  {
