...
describe("FAQSection Component", () => {
  describe("Rendering", () => {
    ...
    it("should render the subtitle", () => {
      ...
      expect(screen.getByText(/Everything you need to know about the product and billing/i)).toBeInTheDocument();
    });
  ...
  describe("FAQ Content", () => {
    ...
    it("should include question about accountability", () => {
      ...
      expect(screen.getByText(/Can I run my program on another platform and use Karma just for accountability/i)).toBeInTheDocument();
    });

    it("should include question about transparency", () => {
      renderWithProviders(<FAQSection />);
      
      expect(screen.getByText(/How does Karma ensure accountability and transparency?/i)).toBeInTheDocument();
    });

    it("should include question about integrating existing mechanisms", () => {
      renderWithProviders(<FAQSection />);
      
      expect(screen.getByText(/Can I integrate my existing funding or evaluation mechanisms?/i)).toBeInTheDocument();
    });
    ...
    it("should include question about tool integration", () => {
      ...
      expect(screen.getByText(/Can Karma integrate with our existing tools or platforms?/i)).toBeInTheDocument();
    });

    it("should include question about whitelabel version", () => {
      renderWithProviders(<FAQSection />);
      
      expect(screen.getByText(/Can we launch a whitelabel version of Karma for our ecosystem?/i)).toBeInTheDocument();
    });
  });
