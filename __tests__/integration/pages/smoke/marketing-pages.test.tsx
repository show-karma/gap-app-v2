...
describe("/foundations marketing page", () => {
  it("renders all foundation sections", async () => {
    await renderPage(() => import("@/app/t/[tenant]/foundations/page"));
    [
      "foundations-hero",
      "home-pain-points",
...
describe("/ marketing page (funder workflow)", () => {
  it("renders hero and the workflow section", async () => {
    await renderPage(() => import("@/app/t/[tenant]/page"));
...
describe("/nonprofits marketing page", () => {
  it("renders hero, profile preview, features, free tools, cta", async () => {
    await renderPage(() => import("@/app/t/[tenant]/nonprofits/page"));
    [
      "nonprofits-hero",
...
describe("/donor-advisors marketing page", () => {
  it("renders hero, features, cta", async () => {
    await renderPage(() => import("@/app/t/[tenant]/donor-advisors/page"));
...
describe("/funders marketing page", () => {
  it("renders all funder sections", async () => {
    await renderPage(() => import("@/app/t/[tenant]/funders/page"));
    [
      "funders-hero",
      "funders-numbers",
      "funders-platform",
...
describe("/for-projects marketing page", () => {
  it("renders core homepage feature sections", async () => {
    await renderPage(() => import("@/app/t/[tenant]/for-projects/page"));
...
describe("/seeds marketing pages", () => {
  it("/seeds renders all launch sections", async () => {
    await renderPage(() => import("@/app/t/[tenant]/seeds/page"));
    [
      "seeds-launch-hero",
  ...
  it("/seeds/fund renders all fund sections", async () => {
    await renderPage(() => import("@/app/t/[tenant]/seeds/fund/page"));
    [
      "seeds-hero",
      "seeds-how-it-works",
      "seeds-benefits",
...
describe("/projects explorer page", () => {
  it("renders hero, explorer, stats", async () => {
    ...
    const { default: ProjectsPage } = await import("@/app/t/[tenant]/projects/page");
