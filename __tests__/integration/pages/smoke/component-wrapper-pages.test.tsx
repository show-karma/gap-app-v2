...
vi.mock(
  "@/app/t/[tenant]/(chrome)/community/[communityId]/(whitelabel)/claim-funds/ClaimFundsClient",
  () => ({
    __esModule: true,
...
describe("Top-level component-wrapper pages", () => {
  it("/dashboard renders the dashboard overview", async () => {
    await renderPage(() => import("@/app/t/[tenant]/(chrome)/dashboard/page"));
    expect(screen.getByTestId("dashboard-component")).toBeInTheDocument();
  });

  it("/communities renders CommunitiesPage", async () => {
    await renderPage(() => import("@/app/t/[tenant]/(chrome)/communities/page"));
    expect(screen.getByTestId("communities-page")).toBeInTheDocument();
  });

  it("/funding-map/add-program renders AddProgramWrapper", async () => {
    await renderPage(() => import("@/app/t/[tenant]/(chrome)/funding-map/add-program/page"));
...
describe("Community manage component-wrapper pages", () => {
  it("/manage/control-center renders ControlCenterPage", async () => {
    await renderPage(
      () => import("@/app/t/[tenant]/(chrome)/community/[communityId]/manage/control-center/page")
    );
  ...
  it("/manage/edit-categories renders EditCategoriesPage", async () => {
    await renderPage(
      () => import("@/app/t/[tenant]/(chrome)/community/[communityId]/manage/edit-categories/page")
    );
  ...
  it("/manage/edit-projects renders EditProjectsPage", async () => {
    await renderPage(
      () => import("@/app/t/[tenant]/(chrome)/community/[communityId]/manage/edit-projects/page")
    );
...
describe("Community with-header component-wrapper pages", () => {
  ...
  it("/(with-header)/impact/project-discovery renders ProjectDiscovery", async () => {
    await renderPage(
      () =>
        import(
          "@/app/t/[tenant]/(chrome)/community/[communityId]/(with-header)/impact/project-discovery/page"
        )
    );
