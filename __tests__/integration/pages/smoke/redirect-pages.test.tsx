...
describe("Redirect-only pages", () => {
  it("/admin/communities redirects to /admin", async () => {
    const { default: Page } = await import("@/app/t/[tenant]/(chrome)/admin/communities/page");
  ...
  it("/(whitelabel)/applications redirects to /dashboard", async () => {
    const { default: Page } = await import(
      "@/app/t/[tenant]/(chrome)/community/[communityId]/(whitelabel)/applications/page"
    );
  ...
  it("/(whitelabel)/programs redirects to community funding-opportunities", async () => {
    const { default: Page } = await import(
      "@/app/t/[tenant]/(chrome)/community/[communityId]/(whitelabel)/programs/page"
    );
  ...
  it("/manage/funding-platform/[programId] redirects to question-builder", async () => {
    const { default: Page } = await import(
      "@/app/t/[tenant]/(chrome)/community/[communityId]/manage/funding-platform/[programId]/page"
    );
    await expect(
  ...
  it("/manage/funding-platform/[programId]/milestones redirects", async () => {
    const { default: Page } = await import(
      "@/app/t/[tenant]/(chrome)/community/[communityId]/manage/funding-platform/[programId]/milestones/page"
    );
  ...
  it("/manage/payouts permanent-redirects to control-center", async () => {
    const { default: Page } = await import(
      "@/app/t/[tenant]/(chrome)/community/[communityId]/manage/payouts/page"
    );
    await expect(
      Page({
  ...
  it("/(with-header)/browse-applications/[referenceNumber] permanent-redirects", async () => {
    const { default: Page } = await import(
      "@/app/t/[tenant]/(chrome)/community/[communityId]/(with-header)/browse-applications/[referenceNumber]/page"
    );
    await expect(
