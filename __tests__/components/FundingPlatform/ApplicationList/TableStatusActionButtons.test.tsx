...
describe('TableStatusActionButtons', () => {
  ...
  describe('TableStatusActionButton Component', () => {
    it('should render button with correct label', () => {
      render(
        <TableStatusActionButtons {...defaultProps} currentStatus="pending" />
      );
    ...
    it('should render icon when provided', () => {
      render(
        <TableStatusActionButtons {...defaultProps} currentStatus="under_review" />
      );
  ...
  describe('TableStatusActionButtons Component - Status Transitions', () => {
    ...
    describe('revision_requested status', () => {
      it('should render Review button for revision_requested status', () => {
        render(
          <TableStatusActionButtons {...defaultProps} currentStatus="revision_requested" />
        );
  ...
  describe('Disabled State', () => {
    it('should disable all buttons when isUpdating is true', () => {
      render(
        <TableStatusActionButtons {...defaultProps} currentStatus="under_review" isUpdating={true} />
      );
    ...
    it('should enable buttons when isUpdating is false', () => {
      render(
        <TableStatusActionButtons {...defaultProps} currentStatus="under_review" isUpdating={false} />
      );
