...
describe('ExternalLink', () => {
  ...
  describe('Href Variations', () => {
    ...
    it('should handle URLs with paths', () => {
      render(
        <ExternalLink href="https://example.com/path/to/page">Link</ExternalLink>
      );
    ...
    it('should handle URLs with query parameters', () => {
      render(
        <ExternalLink href="https://example.com?param=value">Link</ExternalLink>
      );
    ...
    it('should handle URLs with hash fragments', () => {
      render(
        <ExternalLink href="https://example.com#section">Link</ExternalLink>
      );
