...
describe("ProfilePicture", () => {
  describe("Image Rendering", () => {
    ...
    it("should use name as alt text when alt prop is not provided", () => {
      render(<ProfilePicture imageURL="https://example.com/image.jpg" name="Jane Smith" />);
  ...
  describe("Avatar Fallback", () => {
    ...
    it("should pass correct colors to boring-avatar", () => {
      ...
      expect(colors).toEqual(["#92A1C6", "#146A7C", "#F0AB3D", "#C271B4", "#C20D90"]);
    });
    ...
    it("should apply custom className to avatar wrapper", () => {
      const { container } = render(<ProfilePicture name="John Doe" className="custom-wrapper" />);
  ...
  describe("Fallback Alt Text", () => {
    it('should use "Profile" as fallback when name and alt are empty', () => {
      render(<ProfilePicture imageURL="https://example.com/image.jpg" name="" alt="" />);
  ...
  describe("Styling", () => {
    ...
    it("should apply className to wrapper div for avatar fallback", () => {
      const { container } = render(<ProfilePicture name="John Doe" className="w-20 h-20" />);
  ...
  describe("Component Switching", () => {
    ...
    it("should switch from image to avatar when URL becomes invalid", () => {
      const { rerender } = render(
        <ProfilePicture name="John Doe" imageURL="https://example.com/image.jpg" />
      );
