...
describe('GrantPercentage', () => {
  ...
  describe('Rendering', () => {
    ...
    it('should not render when percentage is 0', () => {
      const { container } = render(
        <GrantPercentage grant={mockGrantWithNoProgress as any} />
      );
    ...
    it('should apply custom className to span', () => {
      render(
        <GrantPercentage
          grant={mockGrantWithMilestones as any}
  ...
  describe('Percentage Calculation', () => {
    ...
    it('should return 0 when no milestones are completed', () => {
      ...
      const { container } = render(
        <GrantPercentage grant={noneCompleted as any} />
      );
  ...
  describe('Edge Cases', () => {
    it('should handle empty milestones array', () => {
      ...
      const { container } = render(
        <GrantPercentage grant={emptyMilestones as any} />
      );
    ...
    it('should handle undefined milestones', () => {
      ...
      const { container } = render(
        <GrantPercentage grant={noMilestones as any} />
      );
    ...
    it('should handle NaN completion percentage gracefully', () => {
      ...
      const { container } = render(
        <GrantPercentage grant={invalidPercentage as any} />
      );
  ...
  describe('Memoization', () => {
    it('should recalculate percentage when grant changes', () => {
      const { rerender } = render(
        <GrantPercentage grant={mockGrantWithMilestones as any} />
      );
