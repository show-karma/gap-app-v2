...
import { milestoneReviewersService, MilestoneReviewer, AddMilestoneReviewerRequest } from '@/services/milestone-reviewers.service';
...
describe('milestoneReviewersService', () => {
  ...
  describe('getReviewers', () => {
    ...
    it('should throw error for non-404 errors', async () => {
      ...
      await expect(
        milestoneReviewersService.getReviewers('program-1', 1)
