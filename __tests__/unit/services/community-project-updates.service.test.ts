import { fetchCommunityProjectUpdates, FetchCommunityProjectUpdatesParams } from '@/services/community-project-updates.service';
...
describe('fetchCommunityProjectUpdates', () => {
  ...
  describe('Error handling', () => {
    it('should handle HTTP errors', async () => {
      ...
      await expect(
        fetchCommunityProjectUpdates({ communityId: 'non-existent' })
      ).rejects.toThrow('Failed to fetch community updates: 404 Not Found');
    ...
    it('should handle errors when reading error response text fails', async () => {
      ...
      ).rejects.toThrow('Failed to fetch community updates: 500 Internal Server Error');
    ...
    it('should handle JSON parsing errors', async () => {
      ...
      await expect(
        fetchCommunityProjectUpdates({ communityId: 'community-1' })
      ).rejects.toThrow('Server returned invalid JSON');
