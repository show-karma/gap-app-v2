...
import { programReviewersService, ProgramReviewer, AddReviewerRequest } from '@/services/program-reviewers.service';
...
describe('programReviewersService', () => {
  ...
  describe('getReviewers', () => {
    ...
    it('should throw error for server errors', async () => {
      ...
      await expect(
        programReviewersService.getReviewers('program-1', 1)
  ...
  describe('addMultipleReviewers', () => {
    it('should add multiple reviewers successfully', async () => {
      ...
      const result = await programReviewersService.addMultipleReviewers(
        'program-1',
        1,
        reviewers
      );
