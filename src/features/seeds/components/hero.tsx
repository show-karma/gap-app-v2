      ...
      <SectionContainer className="flex flex-col items-center gap-6">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-12 mt-8 pt-8 border-t border-border w-full max-w-[768px]">
          <div className="flex flex-col items-center">
            ...
            <span className="text-sm text-muted-foreground">= 1 Seed</span>
          </div>
          <div className="flex flex-col items-center">
            <span className="text-3xl font-bold text-green-600 dark:text-green-400">ERC-20</span>
            <span className="text-sm text-muted-foreground">token in your wallet</span>
          </div>
          <div className="flex flex-col items-center">
            <span className="text-3xl font-bold text-green-600 dark:text-green-400">Fixed</span>
            <span className="text-sm text-muted-foreground">price by design</span>
          </div>
        </div>
      </SectionContainer>
    </section>
