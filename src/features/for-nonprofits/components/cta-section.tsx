      ...
      <SectionContainer>
        <div className="flex flex-col items-center gap-6">
          ...
          <div className="flex flex-col md:flex-row items-center gap-4 w-full md:w-auto px-4 md:px-0">
            ...
            >
              <Link href={PAGES.CREATE_PROJECT_PROFILE}>Create your profile</Link>
            </Button>
