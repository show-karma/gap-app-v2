...
export function NonprofitPageHeader({ eyebrow, title, description, actions }: Props) {
  return (
    <header className="flex flex-col gap-3 border-b border-gray-200 dark:border-zinc-800 pb-6 md:flex-row md:items-end md:justify-between">
      <div className="min-w-0">
        ...
        {description ? (
          <p className="mt-2 max-w-2xl text-sm text-gray-600 dark:text-zinc-400">{description}</p>
        ) : null}
      </div>
