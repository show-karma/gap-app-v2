...
function FeatureCard({ title, description, image, checklist, size = "default", imageSize = "medium", imageWidth, imageHeight, imagePosition = "top" }: FeatureCardProps) {
...
const features = [
  {
    ...
    description: "Create a comprehensive project profile and showcase your work across multiple funding programs, share updates and build reputation onchain.",
  ...
  },
  {
    ...
    description: "Link your project to multiple grant rounds, hackathons, and retro funding programs — all under one profile.",
  ...
  },
  {
    ...
    description: "Accept funding directly on your project page through fiat and onchain payments or ecosystem grant disbursals.",
  ...
  },
  {
    ...
    description: "Automatically track activity from GitHub, smart contracts, and other sources by easily linking your repos and contracts.",
  ...
  },
  {
    ...
    description: "Build your onchain reputation by documenting progress and milestones through Karma's GAP protocol.",
    image: "/images/homepage/builder-features-05.png",
    checklist: [
      "Add project deliverables",
      "Add custom metrics to show impact",
    ],
    imageSize: "medium" as const,
    size: "double" as const,
  },
  {
    ...
    description: "Receive onchain endorsements from supporters, funders, and collaborators that strengthen your credibility.",
    ...
    <section className={cn(homepageTheme.padding, "py-16 w-full")}>
      ...
      <div className="flex flex-col items-start gap-4 mb-12">
        ...
        <p className="text-base md:text-lg text-muted-foreground max-w-3xl">
          We support builders across their lifecycle to access funding opportunities, grow their reputation and track their progress easily.
        </p>
      </div>
