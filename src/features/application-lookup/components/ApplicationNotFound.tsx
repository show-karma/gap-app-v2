...
export function ApplicationNotFound({ error, communityName }: ApplicationNotFoundProps) {
  const title =
          ...
          {error.type === "not_found" && (
            <div className="mt-3 text-xs text-red-600 dark:text-red-400">
              ...
              <ul className="ml-4 mt-1 list-disc space-y-1">
                ...
                <li>You should have received this in your confirmation email</li>
                {communityName && (
                  <li>
                    Make sure you&apos;re on the correct community - you are currently on{" "}
