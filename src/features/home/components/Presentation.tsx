...
import { TypedLoading } from "@/features/home/components/ReactTypedWrap";
...
const ReactTypedWrapper = dynamic(
  () =>
    import("@/features/home/components/ReactTypedWrap").then(
...
const ProjectDialog = dynamic(
  () =>
    import("@/features/projects/components/dialogs/ProjectDialog").then(
