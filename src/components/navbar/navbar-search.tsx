...
export function NavbarSearch() {
    ...
    return (
        <div className="relative flex-1 min-w-20 max-w-[240px]" ref={searchRef}>
            ...
            {isSearchListOpen && (
                <div className="absolute top-full left-0 mt-2 w-full min-w-[350px] max-w-[500px] sm:max-w-[500px] bg-background border border-border rounded-lg shadow-lg z-50 overflow-hidden" style={{ width: 'min(100%, 500px)', minWidth: '350px' }}>
                    {isLoading ? (
                        ...
                        <div className="max-h-72 w-full overflow-y-auto overflow-x-hidden">
                            <div className="flex flex-col gap-1 py-3 px-3 min-w-0 w-full" style={{ maxWidth: '100%', boxSizing: 'border-box' }}>
