...
// Only mounts once the user is denied, so the application lookup never runs for
// authorized reviewers/admins. If the denied user is an applicant in this
// program/community, send them to their application instead of the generic denial.
