...
const schema = z.object({
  email: z.string().min(3, { message: MESSAGES.COMMUNITY_FORM.TITLE }),
  telegram: z.string().min(3, { message: MESSAGES.COMMUNITY_FORM.TITLE }),
});
...
export const RequestIntro: FC<AddAdminDialogProps> = ({
  buttonElement = {
                  ...
                  </button>
                  {
                    <div className="mt-2">
                      <p className="text-sm text-gray-600 dark:text-zinc-300">
                        Fill out these details to request the intro about the
                        project
                      </p>
                    </div>
                  }
                    ...
                    <div className="w-full px-2 py-4 sm:px-0">
                      <div className="flex w-full flex-col gap-2">
                        ...
                        <input
                          ...
                          placeholder='e.g. "karma@gmail.com"'
                          {...register("email")}
                        />
                      </div>
                    </div>
