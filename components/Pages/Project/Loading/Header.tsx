...
export default function ProjectHeaderLoading() {
  return (
    <div className="relative border-b border-gray-200 ">
      <div className={cn(layoutTheme.padding, "lg:flex py-5 lg:items-start lg:justify-between flex flex-row max-lg:flex-col max-lg:justify-center max-lg:items-center gap-4")}>
