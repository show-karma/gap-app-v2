...
interface AboutContentServerProps {
  project: Project;
  className?: string;
}
...
/**
 * Server-rendered version of AboutContent. Emits the project's unique narrative
 * (description, mission, problem, solution, …) directly into the server HTML so
 * search engines see real content instead of a client-side loading skeleton.
 * The interactive client AboutContent remains for the in-app tabbed view.
 */
export function AboutContentServer({ project, className }: AboutContentServerProps) {
