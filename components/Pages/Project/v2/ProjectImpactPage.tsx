...
interface ProjectImpactPageProps {
  className?: string;
}

/**
 * ProjectImpactPage renders the project profile layout with the Impact tab selected.
 *
 * This component reuses the same layout structure as ProjectProfilePage:
 ...
 * - ProjectMainContent: Tabs (Impact selected), Impact content
 *
 * Data Flow (DDD):
 * - Uses useProjectProfile hook to aggregate all data sources
 * - Business logic is delegated to project-profile.service.ts
 */
export function ProjectImpactPage({ className }: ProjectImpactPageProps) {
  ...
  return (
    ...
    >
      ...
      <div
        ...
        data-testid="project-impact-page"
      >
        ...
        <div className="flex flex-row gap-6" data-testid="main-layout">
          ...
          {/* Main Content - Impact tab selected */}
          <ProjectMainContent
            project={project}
