...
/**
 * ProjectFundingPage displays the funding/grants page using the new v2 project profile layout.
 *
 * Layout (matches ProjectProfilePage):
 ...
 * - FundingTabs: Tab navigation with "Funding" tab selected
 * - FundingContent: List of grants for the project
 */
export function ProjectFundingPage({ className }: ProjectFundingPageProps) {
  ...
  if (isLoading || !project) {
    return (
      <div
        ...
        data-testid="funding-page-loading"
      >
      ...
      fallback={
        <div className="p-6 rounded-lg bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800">
          <h3 className="text-lg font-medium text-red-800 dark:text-red-400 mb-2">
            Unable to load project funding
          </h3>
          <p className="text-sm text-red-700 dark:text-red-300">
            Something went wrong while loading the project funding. Please try refreshing the page.
          </p>
        </div>
      }
    >
      ...
      <div
        ...
        data-testid="project-funding-page"
      >
        ...
        <div className="flex flex-row gap-6" data-testid="main-layout">
          ...
          {/* Main Content */}
          <div className="flex flex-col gap-6 flex-1 min-w-0" data-testid="funding-main-content">
            {/* Tabs with Funding selected */}
            <FundingTabs fundingCount={stats.grantsCount} teamCount={teamCount} />

            {/* Funding Content */}
            <FundingContent project={project} />
          </div>
        </div>
      </div>
    </ErrorBoundary>
