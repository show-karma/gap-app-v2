            ...
            >
              {metricNames.map((metric) => (
                ...
                >
                  ...
                  <Label className="ml-2 hover:cursor-pointer">{formatMetricName(metric)}</Label>
                </Field>
              ))}
            </RadioGroup>
          </Card>
        ...
        <div className="col-span-9">
          {isLoading ? (
            ...
            <div className="space-y-6">
              ...
              <Card>
                <Title>{formatMetricName(selectedMetric)} - Community Wide Total</Title>
                <AreaChart
                  className="h-72 mt-4"
                  data={chartDataTotal}
                  index="date"
              ...
              <Card>
                <Title>{formatMetricName(selectedMetric)} - Project Wise Avg, Max, Min</Title>
                <AreaChart
                  className="h-72 mt-4"
                  data={chartData}
                  index="date"
                  categories={["Daily Average", "Daily Maximum", "Daily Minimum"]}
