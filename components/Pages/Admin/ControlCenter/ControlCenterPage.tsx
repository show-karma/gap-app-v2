...
import { useAutoOpenGrantFromUrl } from "./useAutoOpenGrantFromUrl";
...
export function ControlCenterPage() {
  ...
  useAutoOpenGrantFromUrl({
    projectParam,
    grantParam,
    searchQuery,
    isLoading: isLoadingPayouts,
    rows: tableData,
    replaceQuery: (updates) => router.replace(`${pathname}?${createQueryString(updates)}`),
    onOpen: (row) => {
      setDetailsGrantUid(row.grantUid);
