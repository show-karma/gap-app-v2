...
import { fetchProjectGrantMilestones, type MappedMilestone, type ProjectGrantMilestonesResponse } from "@/services/milestones";
...
export function MilestonesReviewPage({
  ...
  const handleSubmitVerification = async (completionId: string) => {
    try {
      // TODO: Call API to verify milestone completion
      console.log("Verifying completion:", completionId, verificationComment);

      // For now, just close the verification form
      setVerifyingMilestoneId(null);
      setVerificationComment("");
                      ...
                      {milestone.completion && (
                        <>
                          ...
                          {milestone.completion.isVerified && milestone.completion.verificationComment ? (
                            ...
                            /* Show Verify Button if status is Pending Verification */
                                ...
                                {verifyingMilestoneId === milestone.completion.id ? (
                                  ...
                                  <div className="p-3 bg-green-50 dark:bg-green-900/10 border border-green-200 dark:border-green-800 rounded-md space-y-2">
                                    ...
                                    <div className="flex gap-2">
                                      <Button
                                        onClick={() => handleSubmitVerification(milestone.completion!.id)}
