    ...
    <div className="mb-10 mt-16 flex flex-row flex-wrap gap-16 max-lg:flex-col">
      <div className="flex max-w-full flex-1 flex-col gap-2.5 max-2xl:max-w-lg max-lg:max-w-full">
        ...
        <p className="text-xl font-normal text-gray-900 max-sm:text-base dark:text-zinc-200">
          Annually, the crypto ecosystem issues grants amounting to millions of dollars. While this
      ...
      <div className="flex flex-1 flex-col gap-6">
        <div className="flex flex-row flex-wrap gap-6">
          <div className="flex min-w-[280px]  flex-1 flex-col items-start gap-3 rounded-3xl  bg-[#D7F8EF] px-8 py-6 max-2xl:px-6">
            ...
            <p className="text-gray-700">
              Currently, it is challenging for grant teams and the community to easily access and
              track project progress and milestones, as information is scattered across forums and
              external links.
            </p>
          </div>
          <div className="flex min-w-[280px]  flex-1 flex-col items-start gap-3 rounded-3xl bg-[#E0EAFF] px-8 py-6 max-2xl:px-6">
            ...
            <p className="text-gray-700">
              Grantees who apply for grants from multiple organizations struggle to establish and
              carry their reputation consistently across the ecosystem. This is particularly
              difficult for individuals who are new to the ecosystem and need opportunities to
              showcase their work and build their reputation.
            </p>
          </div>
        </div>
        <div className="flex min-w-[280px] flex-1 flex-col items-start gap-3 rounded-3xl bg-[#EAECF0] px-8 py-6 max-2xl:px-6">
          ...
          <p className="text-gray-700">
            The absence of structured data that can be accessed in a permissionless manner hampers
            the development of applications and analytical tools for evaluating grant impact and
            builder reputation.
          </p>
        </div>
      </div>
