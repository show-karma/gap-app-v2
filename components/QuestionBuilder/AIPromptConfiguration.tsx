...
export function AIPromptConfiguration({ 
  ...
  const { register, handleSubmit, watch, formState: { errors, isDirty } } = useForm<AIConfigFormData>({
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">
            This prompt defines the core evaluation criteria and approach. It will be used for both real-time and final evaluations.
          </p>
        </div>
        ...
        <div>
          ...
          />
          <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">
            Additional instructions for more comprehensive evaluation. This will be used only for the final evaluation after submission.
          </p>
        </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-1 ml-6">
                Provide instant feedback to applicants as they complete form fields. This uses only the system prompt for faster responses.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4 mt-4">
            ...
            <dl className="text-xs space-y-1">
              <div className="flex justify-between">
                ...
                <dd className="text-gray-900 dark:text-white font-mono">{schema.aiConfig.aiModel}</dd>
              </div>
              <div className="flex justify-between">
