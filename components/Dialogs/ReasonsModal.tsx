  ...
  return (
    <>
      <Button
        ...
        className={`flex items-center gap-x-1 rounded-md px-3 py-2 text-sm font-semibold border ${
          text === "Include"
      ...
      >
        ...
        <span className={`inline-block px-3 py-1 text-sm font-semibold rounded-full`}>{text}</span>
      </Button>
              ...
              >
                <Dialog.Panel className="w-full max-w-7xl transform overflow-hidden rounded-2xl dark:bg-zinc-800 bg-white p-6 text-left align-middle transition-all ease-in-out duration-300">
                  <Dialog.Title as="h3" className=" text-gray-900 dark:text-zinc-100">
                    ...
                    <p className="mt-2">*as evaluated by Karma AI</p>
                  </Dialog.Title>
