...
import { ChevronDownIcon, ClockIcon, LockClosedIcon } from "@heroicons/react/24/outline";
...
function KarmaProfileContextSection({ context }: KarmaProfileContextSectionProps) {
    ...
    <div className="mt-4 rounded-lg border border-zinc-200 dark:border-zinc-700">
      ...
      >
        <span className="flex flex-col gap-0.5">
          <span>Karma profile context used</span>
          <span className="text-xs font-normal text-gray-500 dark:text-gray-400">
            Verify any track-record claim the AI made against this raw block
          </span>
        </span>
        <ChevronDownIcon
