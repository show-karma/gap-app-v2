...
export const useRegistryStore = create<RegistryStore>((set, get) => ({
  ...
  setIsPoolManagerLoading: (isPoolManagerLoading: boolean) =>
    set({ isPoolManagerLoading }),
  isRegistryAdmin: false,
  setIsRegistryAdmin: (isRegistryAdmin: boolean) => set({ isRegistryAdmin }),
  isRegistryAdminLoading: true,
  setIsRegistryAdminLoading: (isRegistryAdminLoading: boolean) =>
    set({ isRegistryAdminLoading }),
}));
