    ...
    <div className="flex flex-col items-center justify-start max-w-full w-full px-8 py-8 text-start mb-10">
      <div className="flex flex-col items-start justify-start h-full max-w-4xl w-full text-start">
        ...
        <p className={styles.p}>
          ...
          <br />
          By continuing to use the Platform, you acknowledge and agree to these
          Terms of Use.
        </p>
        <h2 className={styles.h2}>2. User Submissions</h2>
        <p className={styles.p}>
          When you submit content to the Platform — including but not limited to
          milestones, updates, impact reports, endorsements, or profile
          information — you retain ownership of your content but grant Karma a
          worldwide, non-exclusive, royalty-free license to host, display,
          reproduce, and distribute that content for purposes related to the
          Platform’s operations, including improving transparency and
          accountability for public goods funding.
          <br />
          You are solely responsible for any content you provide and agree not
          to submit anything false, misleading, unlawful, or infringing on the
          rights of others.
        </p>
        ...
        <p className={styles.p}>
          ...
          <br />
          Karma is not responsible for decisions made by funders, communities,
          or other users based on the information provided via the Platform.
        </p>
        <h2 className={styles.h2}>4. Limitation of Liability</h2>
        <p className={styles.p}>
          To the fullest extent permitted by law, Karma and its affiliates shall
          ...
          reliance on any content available through it.
        </p>
        <h2 className={styles.h2}>5. Modifications</h2>
        <p className={styles.p}>
          We reserve the right to update or modify these Terms of Use at any
          time. Changes will be posted to this page with an updated effective
        ...
        <span className={styles.p}>
          ...
          . Please review it to understand how we collect, use, and store your
          data.
        </span>
