  ...
  return (
    <div className="mx-auto max-w-xl px-4 py-12">
      <div className="flex flex-col items-center gap-4 rounded-xl border border-border p-8 text-center">
        ...
        <h1 className="text-xl font-semibold text-foreground">Couldn&apos;t load this report</h1>
        <p className="text-sm text-muted-foreground">
          The report may not exist or something went wrong. Please try again.
        </p>
        {error.digest ? (
        ...
        <div className="flex gap-3">
          ...
          <Link
            href={PAGES.DONOR_RESEARCH.ADMIN}
