      ...
      <div className="flex flex-col items-start justify-start h-full max-w-4xl w-full text-start">
        <div className={styles.block}>
          ...
          <p className={styles.p}>
            Karma (“we”, “us”, or “our”) respects your privacy. This Privacy Policy explains how we
        ...
        <div className={styles.block}>
          ...
          <p className={styles.p}>We collect the following types of information:</p>
          <ul className={styles.ul} style={{ listStyleType: "lower-alpha" }}>
            <li className={styles.li}>
              ...
              <ul className="pl-4 list-inside">
                ...
                <li className={styles.p}>- Profile data (e.g., your name, role, organization)</li>
                <li className={styles.p}>
                  - Contact information if you voluntarily provide it (e.g., email)
                </li>
              </ul>
            </li>
            <li className={styles.li}>
              ...
              <ul className="pl-4 list-inside">
                <li className={styles.p}>- IP address, browser type, device information</li>
                <li className={styles.p}>
                  - Pages viewed, time spent on the site, and actions taken (via analytics tools)
                </li>
              </ul>
            </li>
          </ul>
          <p className={styles.p}>
            We do <b>not</b> collect sensitive personal information (e.g., financial, biometric, or
        ...
        <div className={styles.block}>
          ...
          <ul className="pl-4 list-inside">
            ...
            <li className={styles.p}>
              - Display submitted data (e.g., project milestones, public profiles)
            </li>
            <li className={styles.p}>
              - Enable transparency and accountability in funding ecosystems
            </li>
            <li className={styles.p}>- Analyze engagement for performance and product insights</li>
          </ul>
          <p className={styles.p}>
            We may use anonymized and aggregated data for reporting and research purposes.
          </p>
        </div>
        ...
        <div className={styles.block}>
          ...
          <ul className="pl-4 list-inside">
            ...
            <li className={styles.p}>
              - Partner communities you’ve interacted with (e.g., grant programs)
            </li>
            <li className={styles.p}>
        ...
        <div className={styles.block}>
          ...
          <ul className="pl-4 list-inside">
            <li className={styles.p}>- Access, correct, or delete your data </li>
        ...
        <div className={styles.block}>
          ...
          <p className={styles.p}>
            We retain user-submitted data (like project milestones or updates) for as long as
            necessary to support transparency and reporting, or as required by our partners. You may
            request data deletion unless legally or contractually restricted.
          </p>
        </div>
        <div className={styles.block}>
        ...
        <div className={styles.block}>
          ...
          <p className={styles.p}>
            The Platform may link to third-party sites. We are not responsible for the privacy
