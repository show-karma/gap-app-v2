 ...
 * Handles route-level errors with user-friendly UI
 */
export default function DonationCheckoutError({
  error,
  reset,
}: {
    ...
    <div className="mx-auto max-w-3xl px-4 py-12">
      <div className="rounded-2xl border-2 border-red-200 bg-white p-8 shadow-lg dark:border-red-900/40 dark:bg-zinc-950">
        <div className="mb-6 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
              Your donation cart is safe - we encountered an error loading the page
            </p>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          {parsedError.technicalMessage && error.digest && (
            <details className="rounded-xl bg-gray-50 p-4 dark:bg-gray-900/50">
              ...
              <div className="mt-2 space-y-2 text-xs text-gray-600 dark:text-gray-400">
                ...
                <pre className="overflow-x-auto">{parsedError.technicalMessage}</pre>
              </div>
            </details>
          )}
        </div>
