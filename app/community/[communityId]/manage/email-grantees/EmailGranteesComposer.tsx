...
export function EmailGranteesComposer({ programs }: EmailGranteesComposerProps) {
  ...
  return (
    <div className="space-y-6">
      {/* Program Selector & Application Status Filter */}
      <div className="rounded-xl border border-gray-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 p-6">
        <div
          className={`grid gap-6 ${selectedProgramId ? "grid-cols-1 md:grid-cols-2" : "grid-cols-1"}`}
        >
          <div>
            <label
              htmlFor="program-select"
              className="block text-sm font-bold text-black dark:text-zinc-100 mb-1"
            >
              Select Program
            </label>
            <select
      ...
      {selectedProgramId && (
        <div className="rounded-xl border border-gray-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 p-6 space-y-6">
          {/* Recipients Section */}
          <div>
