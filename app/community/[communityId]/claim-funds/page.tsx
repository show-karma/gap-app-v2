...
function ClaimFundsContent() {
  ...
  } = useCampaigns(communityId, claimGrants);
  ...
  } = useEligibility(campaigns, checkAddress, communityId, claimGrants);
  ...
  const {
    ...
    claimingCampaignId,
  } = useClaimTransaction(communityId, claimGrants);
  ...
  } = useDelegatedClaim(communityId, claimGrants);
