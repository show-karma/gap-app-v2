...
export default function SeedsFundPage() {
  return (
    <main className="flex w-full flex-col flex-1 items-center bg-background seeds-noise overflow-hidden">
      {/* Decorative background blobs */}
      <div className="fixed inset-0 pointer-events-none overflow-hidden" aria-hidden="true">
        <div className="seeds-blob seeds-float absolute -top-32 -right-32 w-96 h-96 bg-seeds-300/10 dark:bg-seeds-300/5 blur-3xl" />
        <div className="seeds-blob seeds-float-delayed absolute top-1/3 -left-48 w-80 h-80 bg-seeds-300/10 dark:bg-seeds-300/5 blur-3xl" />
        <div className="seeds-blob seeds-float-slow absolute bottom-1/4 right-0 w-72 h-72 bg-seeds-300/10 dark:bg-seeds-300/5 blur-3xl" />
      </div>
