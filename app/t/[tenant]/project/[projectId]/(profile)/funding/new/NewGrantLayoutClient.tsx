...
interface NewGrantLayoutClientProps {
  children: React.ReactNode;
}

/**
 * Client-side new grant layout.
 * Provides back button, page title, and form content area.
 */
export function NewGrantLayoutClient({ children }: NewGrantLayoutClientProps) {
