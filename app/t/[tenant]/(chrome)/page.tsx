...
const TITLE = "Karma | AI-powered funding software that does the work for you";
  ...
  return (
    <main className="flex w-full flex-col flex-1 items-center bg-background">
      ...
      <div className="flex w-full max-w-[1920px] justify-center items-center flex-1 flex-col gap-16 lg:gap-24">
        ...
        <HorizontalLine />
        <ObjectionsSection />
        {/* Renders every answer in the server HTML (the shared accordion keeps
            closed answers out of it) and shares its FOUNDATION_FAQS source with
            the FAQPage JSON-LD above. */}
