...
export const QUERY_KEYS = {
    ...
    COMMUNITY: {
        DETAILS: (communityUIDorSlug?: string) =>
            ["communityDetails", communityUIDorSlug] as const,
        ...
        GRANTS: (communitySlug: string) =>
            ["community-grants", communitySlug] as const,
