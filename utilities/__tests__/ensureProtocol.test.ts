...
describe('ensureProtocol', () => {
  describe('URLs with existing protocols', () => {
    ...
    it('should handle URLs with paths', () => {
      ...
      expect(ensureProtocol('http://example.com/path/to/resource')).toBe('http://example.com/path/to/resource');
    });

    it('should handle URLs with query parameters', () => {
      expect(ensureProtocol('https://example.com?param=value')).toBe('https://example.com?param=value');
    ...
    it('should handle URLs with fragments', () => {
      ...
      expect(ensureProtocol('http://example.com/path#anchor')).toBe('http://example.com/path#anchor');
    });
  });
