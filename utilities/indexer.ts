...
export const INDEXER = {
    ...
    V2: {
        PROJECTS: {
            ...
            GRANTS: (projectIdOrSlug: string) =>
                `/v2/projects/${projectIdOrSlug}/grants`,
            ...
            MILESTONES: (projectIdOrSlug: string) =>
                `/v2/projects/${projectIdOrSlug}/milestones`,
            IMPACTS: (projectIdOrSlug: string) =>
                `/projects/${projectIdOrSlug}/impacts`,
        },
        APPLICATIONS: {
        ...
        FUNDING_APPLICATIONS: {
            ...
            REVIEWERS: (applicationId: string) =>
        ...
        REGISTRY: {
            GET_ALL: "/v2/registry",
            GET_BY_ID: (programId: string, chainId: number) =>
                `/v2/registry/${programId}/${chainId}`,
        ...
        TRACKS: {
            ...
            PROGRAM_TRACKS: (programId: string) =>
                `/v2/programs/${programId}/tracks`,
            ASSIGN_TO_PROGRAM: (programId: string) =>
                `/v2/programs/${programId}/tracks`,
            ...
            ASSIGN_TO_PROJECT: (projectId: string) =>
                `/v2/projects/${projectId}/tracks`,
    ...
    PROJECT: {
        EXTERNAL: {
            UPDATE: (projectUID: string) =>
                `/projects/${projectUID}/external/update`,
        },
        CONTRACTS: {
        ...
        GRANTS_GENIE: (projectId: string) =>
            `/projects/${projectId}/grants-genie`,
        ...
        IMPACT_INDICATORS: {
            ...
            SEND: (projectUID: string) =>
                `/projects/${projectUID}/indicators/data`,
        },
        PAYOUT_ADDRESS: {
            UPDATE: (projectUID: string) =>
                `/projects/${projectUID}/payout-address`,
            GET: (projectUID: string) =>
                `/projects/${projectUID}/payout-address`,
        },
        LOGOS: {
            ...
            PROMOTE_TO_PERMANENT: () =>
                `/v2/projects/logos/promote-to-permanent`,
        },
    },
    MILESTONE: {
        IMPACT_INDICATORS: {
    ...
    REGIONS: {
        CREATE: (communityId: string) =>
            `/v2/communities/${communityId}/regions`,
    ...
    COMMUNITY: {
        ...
        V2: {
            ...
            IMPACT_SEGMENTS: (communityUID: string) =>
                `/v2/impact-segments/${communityUID}`,
            INDICATORS: {
                AGGREGATED: (
                    indicatorIds: string,
                    communityUID: string,
            ...
            PROJECTS: (
                ...
                if (selectedProgramId)
                    params.set("programIds", selectedProgramId);
                if (selectedTrackIds?.length)
                    params.set("trackIds", selectedTrackIds.join(","));
        ...
        BATCH_UPDATE: (idOrSlug: string) =>
            `/communities/${idOrSlug}/batch-update`,
        INDICATORS: {
            COMMUNITY: {
    ...
    SUBSCRIPTION: {
        GET: (projectIdOrSlug: string) =>
            `/projects/${projectIdOrSlug}/contacts`,
