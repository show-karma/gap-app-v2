export const SHARE_TEXTS = {
  ...
  PROJECT_ACTIVITY: (title: string, slugOrUid: string, activityUid: string) =>
    `🚀 Just posted an project activity for ${title}!\nCheck out my progress on @karmahq_ GAP and and see how we’re advancing: https://gap.karmahq.xyz/project/${slugOrUid}/funding?grantId=${activityUid}&tab=milestones-and-updates\nYour thoughts and feedback are invaluable—let me know what you think!`,
